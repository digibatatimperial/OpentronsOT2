...
def run(protocol: protocol_api.ProtocolContext):
    ...
    # The drying temperature can be set to 25 °C for room-temperature drying, or 60–80 °C for accelerated drying.
    #DRYING_TEMPERATURE_C = 25 
    ...
    # ============================================================
    # DRYING SEQUENCE — PASSIVE COOLING / ROOM-TEMPERATURE DRYING
    # ============================================================
    protocol.comment(
