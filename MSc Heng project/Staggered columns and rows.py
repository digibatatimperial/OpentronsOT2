...
metadata = {
    "protocolName": "Filter Paper Drop Casting: Ink One Cycle",
    "author": "DIGIBAT Lab",
    "apiLevel": "2.15",
}
...
def run(protocol: protocol_api.ProtocolContext):
    ...
    # ============================================================
    paper_x_mm = 62.0        # length in mm
    paper_y_mm = 32.0        # width in mm
    droplet_gap = 2.5        # mm spacing in both x and y
    ...
    # ============================================================
        ...
        # ============================================================
    # BUILD LAYER 1 AND LAYER 2 GRIDS OVER FILTER PAPER
    # Pattern 3:
    # Layer 1 = regular grid
    # Layer 2 = x- and y-offset by half droplet gap
    ...
    # Pattern 3:
    # Layer 2 fills both x-gaps and y-gaps between Layer 1 droplets.
    # Therefore it has one fewer column and one fewer row.
    ...
    # Optional manual offsets for aligning the whole pattern on the filter paper.
    x_shift_mm = 0.0
    y_shift_mm = 0.0
    ...
    # ============================================================
    # RUN ONE CYCLE — PATTERN 2, 25 mm × 25 mm FILTER PAPER
    # ============================================================
